    ...
    function (e){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                setTimeout('location.href ="listaGrupos.html"', 1000);
            },
...
function memsajeInsertar(datos){
    if(datos.code == 200){
        ...
        <div class="alert alert-warning alert-dimissible fade show" role = "alert">
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="close"></button>
            <strong>El grupo ingresado ya está registrado</strong>
        </div>
        `
    }
}
...
function mensajeEliminar(datos){
    if(datos.code == 200){
        ...
        <div class="alert alert-success alert-dimissible fade show" role = "alert">
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="close"></button>
            <strong>Grupo eliminado exitosamente</strong>
        </div>`;
        setTimeout(cargarDatos, 1000); 
        setInterval(` document.getElementById("modalEditar").remove()`,1000);
        setInterval("location.reload()",2000); 
        ...
        <div class="alert alert-warning alert-dimissible fade show" role = "alert">
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="close"></button>
            <strong>Error al eliminar el grupo</strong>
        </div>`;
    }
}
