...
let nombreModuloLista = "Categorias";
let nombreModuloCrear = "Crear categoria";

//URLS API
let url = "http://127.0.0.1/Sistema-de-Inventario/Api/Categoria/Categoria.php/";
...
if (nombrePagina == nombreModuloCrear){
    ...
    function (evento){
        ...
        .then((datosRespuesta) =>{
            ...
            setTimeout('location.href="listaCategorias.html"', 1000);
        })
        .catch(console.log)
