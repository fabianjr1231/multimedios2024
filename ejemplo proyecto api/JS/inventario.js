...
let nombreModuloLista = "Inventario";
let nombreModuloCrear = "Crear Inventario";

//URLS API
let url = "http://127.0.0.1/Sistema-de-Inventario/Api/Inventario/inventario.php/";
...
if (nombrePagina == nombreModuloCrear){
    ...
    function (evento){
        ...
        .then((datosRespuesta) =>{
            ...
            setTimeout('location.href="listaInventarioV2.html"', 1000);
        })
        .catch(console.log)
        ...
        for (const iterator of datos) {
            datosTabla.innerHTML += `
                ...
                > 
                    ...
                    <td>${iterator.id}</td>
                    <td>${iterator.idProducto}</td>
                    <td>${iterator.cantidad}</td>
                    <td>${iterator.fechaRegistro}</td>
                    <td>${iterator.idUsuario}</td>
...
function editar(objeto) {
    ...
    document.getElementById("idProducto").value = objeto.idProducto;
    document.getElementById("cantidad").value = objeto.cantidad;
    document.getElementById("fechaRegistro").value = objeto.fechaRegistro;
    document.getElementById("idUsuario").value = objeto.idUsuario;
